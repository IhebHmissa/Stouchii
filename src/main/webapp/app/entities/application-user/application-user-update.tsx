  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="stouchiApp.applicationUser.home.createOrEditLabel" data-cy="ApplicationUserCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : applicationUserEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="soldeUserLabel" for="application-user-soldeUser">
                  Solde User
                </Label>
                <AvField id="application-user-soldeUser" data-cy="soldeUser" type="string" className="form-control" name="soldeUser" />
              </AvGroup>
              <AvGroup>
                <Label for="application-user-user">User</Label>
                <AvInput id="application-user-user" data-cy="user" type="select" className="form-control" name="userId">
                  <option value="" key="0" />
                  {users
