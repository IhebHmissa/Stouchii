            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('soldeUser')}>
                    Solde User <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {applicationUserList.map((applicationUser, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{applicationUser.soldeUser}</td>
...
const mapStateToProps = ({ applicationUser }: IRootState) => ({
  ...
  totalItems: applicationUser.totalItems,
  links: applicationUser.links,
