          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('nameCatego')}>
                  Name Catego <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('minMontant')}>
                  Min Montant <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('maxMontant')}>
                  Max Montant <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('periodicty')}>
                  Periodicty <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {categoryList.map((category, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{category.id}</td>
                  <td>{category.type}</td>
                  <td>{category.nameCatego}</td>
                  <td>{category.originType}</td>
                  <td>{category.montant}</td>
                  <td>{category.color}</td>
                  <td>{category.userLogin}</td>
                  <td>{category.minMontant}</td>
                  <td>{category.maxMontant}</td>
                  <td>{category.periodicty}</td>
