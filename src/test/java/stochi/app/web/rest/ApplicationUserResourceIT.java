...
class ApplicationUserResourceIT {
    ...
    private static final Float DEFAULT_SOLDE_USER = 1F;
    private static final Float UPDATED_SOLDE_USER = 2F;
    ...
    public static ApplicationUser createEntity() {
        ApplicationUser applicationUser = new ApplicationUser().soldeUser(DEFAULT_SOLDE_USER);
    ...
    public static ApplicationUser createUpdatedEntity() {
        ApplicationUser applicationUser = new ApplicationUser().soldeUser(UPDATED_SOLDE_USER);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getSoldeUser()).isEqualTo(DEFAULT_SOLDE_USER);
    }
    ...
    void getAllApplicationUsers() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].soldeUser").value(hasItem(DEFAULT_SOLDE_USER.doubleValue())));
    }
    ...
    void getApplicationUser() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.soldeUser").value(DEFAULT_SOLDE_USER.doubleValue()));
    }
    ...
    void putNewApplicationUser() throws Exception {
        ...
        updatedApplicationUser.soldeUser(UPDATED_SOLDE_USER);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getSoldeUser()).isEqualTo(UPDATED_SOLDE_USER);
    }
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.soldeUser(UPDATED_SOLDE_USER);
